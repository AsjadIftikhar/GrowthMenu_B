...
from api.models.order import Order, OrderItem, Cart, Service, ServiceRequirement, FAQ
...
class ServiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Service
        fields = ['id', 'title', 'src', 'description', 'service_faq']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['id', 'customer', 'placed_at', 'status_category', 'overall_status_category', 'due_at', 'items']
